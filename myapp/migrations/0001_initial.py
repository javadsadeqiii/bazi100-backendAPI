...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='relatedComments', to='myapp.comments', verbose_name='کامنت ها'),
        ),
        migrations.AddField(
            model_name='allposts',
            name='platformIds',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likeCount', models.IntegerField(default=0, verbose_name='تعداد لایک')),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='myapp.comments', verbose_name='کامنت')),
                ('parentReplyId', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='myapp.reply', verbose_name='ریپلای والد')),
