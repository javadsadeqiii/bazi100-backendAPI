    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emailContact', models.EmailField(max_length=254, verbose_name='ایمبل')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiryTimestamp', models.DateTimeField(verbose_name=' تاریخ و ساعت نظرسنجی')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polls', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.polls', verbose_name='نظرسنجی')),
            ],
            options={
                'verbose_name': 'گزینه',
