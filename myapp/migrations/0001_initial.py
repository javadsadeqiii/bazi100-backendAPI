    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='myapp.user', verbose_name='آیدی کاربر')),
            ],
            options={
                'verbose_name': 'کامنت',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_replies', to='myapp.user', verbose_name='آیدی کاربر')),
            ],
            options={
                'verbose_name': 'ریپلای',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.user', verbose_name='آیدی کاربر')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userliker', to='myapp.user', verbose_name='آیدی کاربر')),
            ],
            options={
                'verbose_name': 'لایک کامنت ها',
                'verbose_name_plural': 'لایک کامنت ها',
