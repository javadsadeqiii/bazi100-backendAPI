# Generated by Django 5.0 on 2024-01-14 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(null=True, verbose_name='فایل والپیپر')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downloadType', models.CharField(blank=True, max_length=2000, null=True)),
                ('dlResetDate', models.DateTimeField(default=django.utils.timezone.now, verbose_name='تاریخ آخرین اتمام تعداد دانلودها')),
                ('dlRemainingDays', models.IntegerField(default=30, verbose_name='روز باقی\u200cمانده')),
                ('dlLastRechargeDate', models.DateTimeField(default=django.utils.timezone.now, verbose_name='تاریخ آخرین آپدیت دانلودها')),
