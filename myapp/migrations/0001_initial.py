    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.comments', verbose_name='آیدی کامنت')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likeCount', models.IntegerField(default=0, verbose_name='تعداد لایک')),
                ('commentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='myapp.comments', verbose_name='کامنت')),
                ('parentReplyId', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='myapp.reply', verbose_name='پاسخ به پاسخ')),
